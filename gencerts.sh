...
openssl req -newkey rsa:2048 -sha256 -nodes -keyout priv.key -x509 -days 365 -out pub.pem -subj 
"/C=US/ST=New York/L=Brooklyn/O=Example Brooklyn Company/CN=20.223.203.100"
